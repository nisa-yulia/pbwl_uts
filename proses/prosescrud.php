...
class prosesCrud {
    ...
    function proses_login($user,$pass)
    {
        ...
        $row = $this->db->prepare('SELECT * FROM tb_user WHERE nama_user=? AND password=?');
    ...
    function tampil_transaksi()
    {
        ...
        $row = $this->db->prepare('SELECT * FROM tb_pesanan JOIN tb_menu ON tb_pesanan.id_menu_pesanan=tb_menu.id_menu ORDER BY id_pesanan ASC');
        $row->execute();
    ...
    function edit_pesanan($where,$id)
    {
        $row = $this->db->prepare("SELECT * FROM tb_pesanan JOIN tb_menu ON tb_pesanan.id_menu_pesanan=tb_menu.id_menu WHERE $where = ?");
